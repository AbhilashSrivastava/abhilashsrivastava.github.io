		...
		if (typeof StripeCheckout == "undefined"){
			$.getScript( "https://checkout.stripe.com/checkout.js", function( data, textStatus, jqxhr ) {
				SpimeEngine.stripePaymentHandler =  StripeCheckout.configure({
				    ...
				    //key: 'pk_test_QSMNJ1sezwb2M4OzwzXm9MNU',
				   // image: '/img/documentation/checkout/marketplace.png',
				    ...
				    token: function(token,args) {
				      ...
				      SpimeEngine.stripePaymentParams["store_name"] = $("body").attr("data-store-name");
				      //console.log(JSON.stringify(SpimeEngine.stripePaymentParams));
	...
	if (SpimeEngine.ecommerceSolution == "IMOS"){
		...
		if (productType == "PHYSICAL"){
			...
			if (shippingCost){
				...
				var currencyArr = {"USD":"$","EUR":"\u20ac","GBP":"\u00a3","JPY":"\u00a5","SEK":"Kr","CHF":"CHF","NOK":"kr"};
